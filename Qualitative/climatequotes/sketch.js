...
textSize(14);
text('How Are Politicians Choosing to Sell their Skepticism on Climate Change?', 150, 50);
//draw key
  noStroke();
textSize(8);
fill (255, 140, 140);
...
//draw timeline
fill ('white');
rect (100,25,25,windowHeight);
     textFont(myFont);
     textSize(16);
text('2013',50,windowHeight*.05);
text('2014',50,windowHeight*.30);
text('2015',50,windowHeight*.55);
text('2016',50,windowHeight*.80);
